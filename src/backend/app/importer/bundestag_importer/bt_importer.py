...
from backend.app.facades.bundestag.facade import BundestagFacade
...
class BTImporter(
    HttpImporter[BundestagFacade, PydanticDataModelType, PydanticParameterModelType, SQLModelType]
):
    ...
    def __init__(
        ...
        super().__init__(
            crud=crud,
            facade=BundestagFacade.get_instance(Settings()),
