...
class WordCounter:
    ...
    def remove_words(self):
        german_articles = [
            ...
            'Die', 'Die', 'Die', 'Keine',
            # Special forms
            'Zur', 'Zum', 'Zur', 'Zur', 'Zu den', 'Zu der', 'Zu dem', 'Zu der', 'Dessen', 'Deren',
            # Common prepositions
            'Mit', 'Ohne', 'An', 'Auf', 'In', 'Unter', 'Über', 'Vor', 'Hinter', 'Neben', 'Zwischen', 'Bei', 'Nach',
            'Seit', 'Während', 'Gegenüber',
            ...
            'Mit', 'Ohne', 'An', 'Auf', 'In', 'Unter', 'Über', 'Vor', 'Hinter', 'Neben', 'Zwischen', 'Bei', 'Nach',
            'Seit', 'Während', 'Gegenüber', 'Außerhalb', 'Innerhalb', 'Entlang', 'Durch', 'Für', 'Wegen', 'Trotz',
            'Bis', 'Zu',
            # Personal pronouns
            ...
            # Possessive pronouns
            'Mein', 'Dein', 'Sein', 'Ihr', 'Sein', 'Unser', 'Euer', 'Ihr', 'Ihr', 'Meiner', 'Deiner', 'Seiner', 'Ihrer',
            'Seiner', 'Unser', 'Euer', 'Ihrer', 'Ihrer', 'Meins', 'Deins', 'Seins', 'Ihres', 'Seins', 'Unser', 'Euer',
            'Ihres', 'Ihres', 'Meinem', 'Deinem', 'Seinem', 'Ihrem', 'Seinem', 'Unserem', 'Eurem', 'Ihrem', 'Ihrem',
        ...
        top100 = [
            # noise 2023
            'Übereinkommen', 'Bekämpfung', 'Feststellung', 'Stand',
            'Anforderungen', 'Bundesrepublik', 'Begrüßung', 'Unterrichtung', 'Mrd', 'Vereinbarung',
            'Bundestagsdrucksache',
            'Länder', 'Vorschriften', 'Ratsdok.', 'Kommission', 'Stärkung', 'Jahre', 'Verzicht',
            'Erleichterung', 'Jahr',
            'Bund', 'Mio', 'Sozialausschuss', 'Mitteln', 'Verteidigung', 'Maßnahmen', 'Steigerung',
            'Anlagen', 'Entscheidung',
            'Ergänzung', 'Finanzierung', 'Robert', 'Festlegung',
            'Anhebung', 'Reduzierung', 'Bundesregierung,',
            'Bewertung', 'Beschluss', 'Übertragung', 'Ordnungsrufes', 'Zustimmung', 'Lage', 'Grundlage',
            'Mitgliedstaaten', 'BT-Drs', 'Unternehmen', 'Möglichkeit',
            'Beteiligung', 'Bundesminister', 'Indikativen', 'Vermeidung', 'Einrichtung', 'Namen',
            'EUZBBG', 'Kosten', 'Sammelübersicht',
            'Europa', 'Berücksichtigung', 'Daten', 'Internationalen', 'Prüfung', 'Absatz', 'Stellungnahme',
            'Beibehaltung', 'Einfügung', 'Anpassungen', 'Antwort',
            'Bundesministerin', 'Recht', 'Prozent', 'Personen', 'Klarstellung', 'WP', 'Aufnahme', 'Gesetz', 'Aufhebung',
            'Richtlinie', 'GESTA', 'Modernisierung', 'Ermöglichung', 'Wann', 'Auswirkungen',
            'BvR', 'Rahmen', 'Bezug:', 'Ende', 'Schaffung', 'Vorschlag',
            'Verordnungsermächtigung', 'Bundesministeriums', 'Informationen',
            'Kenntnis', 'Gesetzes', 'Beschlusses', 'Erteilung', 'Titeländerung', 'Hintergrund',
            'Förderung', 'Sozial', 'Zusammenhang', 'Schutz', 'Einhaltung',
            'Menschen', 'Sondervermögens', 'Olaf', 'Neufassung', 'Entschließung', 'EU', 'Vorlage', 'Bereich',
            'Verwendung', 'Entlastung', 'Nutzung', 'Originaltext', 'Änderungen', 'Bundestages',
            'Ländern', 'Aufbau', 'Anwendung', 'Kommunen', 'Wie', 'Gemeinsamer', 'Gesetzen',
            'Bundesministerium', 'Höhe', 'Union', 'Rat,', 'Arbeit', 'Sicherheit',
            'Rechtsverordnungen;', 'Ausgaben', 'Wirtschafts-', 'Staaten', 'Koalitionsvertrag', 'Wahl', 'Europäische',
            'Verlangen', 'Mitteilung', 'Verbesserung', 'Ausschuss',
            'Verpflichtung', 'Sicht', 'Europäischen', 'Zusammenarbeit', 'Petitionsausschusses',
            'Auffassung', 'Fortsetzung', 'Rat', 'EP', 'Regelung', 'Parlament,', 'Vorschau', 'Gewährleistung', 'AG',
            'Deutschen', 'Abgabe', 'Rechts', 'Reform', 'Frage', 'Investitionen', 'Jahren', 'Hinblick',
            'Bereitstellung', 'Parlaments', 'Regelungen', 'Aussprache', 'Anlage', 'Siehe', 'Erweiterung',
            'Anträge', 'Folgeänderungen', 'Empfehlung', 'Änderung', 'Verfahren',
            'Vorlage,', 'Regionen', 'Vorhaben', 'Bundesregierung',
            'Republik', 'Gesetzentwurf', 'Klarstellungen', 'Bundes', 'Deutschland', 'Verlängerung',
            'Angabe', 'Ausschusses:', 'Pflicht', 'Anzahl', 'Fraktion', 'Deutschlands', 'Erhöhung', 'Buch', 'Erneute',
            'Durchführung', 'Versorgung', 'Deutsche', 'Mittel', 'Sicherstellung',
            'Euro,', 'Anpassung', 'Parlament', 'Petitionen', 'Richtlinien',
            'Übereinkommens', 'Verordnung', 'Einsatz', 'Bezug', 'Abg', 'Rates', 'Zusätzliche',
            'Verhinderung', 'Annahme', 'Bundestag', 'Unterstützung', 'Sicherung', 'Ausweitung', 'Zugang', 'Mitglieder',
            'Weiterentwicklung', 'Ausbau', 'Beendigung', 'EuB-BReg', 'Entwicklung',
            'Einführung', 'Umsetzung', 'Beschleunigung', 'Bundeshaushalt', 'Evaluierung',
            'Hat', 'Vorgaben', 'Bundesministers', 'Standards', 'Forschung', 'Anerkennung',
            'Status', 'Bericht', 'Verbot', 'Euro', 'Fragestunde', 'Entschließungsantrag', 'Absenkung',

            # noise 2022
            "Debatte", "Mögliche", "Schlussfolgerungen", "Verordnungen", "Erlass", "Instrument",
            "Veröffentlichung", "Thema", "Entscheidungen", "Bewältigung", "Allgemeine", "Zahlen", "Vertrag", "Position",
            "Fonds", "Bereichen", "Staates", "GmbH", "Rechte", "Erklärung", "Erhalt", "Staat", "Historische",
            "Beschluss",
            "Petition", "Einrichtungen", "Erhebung", "Ergebnisse", "Plenarprotokoll", "Evaluation", "Begrenzung",
            "Beratung", "Einbeziehung", "Senkung""Rahmenbedingungen", "Fall", "Errichtung", "Cent", "Zahl", "Folgen",
            "Abschaffung", "Wegfall", "Durchsetzung", "Zeitraum",
            "Betrieb", "Rechtsverordnung", "Artikel", "Einnahmen", "Monate", "Ausgestaltung", "Schriftliche", "Plant",
            "Regierungsvorlage", "Reformen",
            "Geschäftsordnung", "Behörden", "Entwurf", "Beginn", "Gemeinsamen", "Form", "Überprüfung",
            "Mündliche", "Fragen", "Ansicht", "Gebiet", "Vereinfachung", "Verschiebung", "Falle", "Wird",
            "Rahmenbedingungen", "Durchführungsbeschluss", "Abgeordneten", "Gewährleistungsermächtigungen", "Gründen",
            "Antrag", "Rechtsverordnungen", "Person",
            "Streichung", "Senkung", "Inanspruchnahme",
            "Innern", "Frauen",
            "Bürger", "Teil", "Ziele", "Meldung", "Konsequenzen", "Verhandlungen",
            "Mitglied", "Beschränkung", "Bestimmung", "Reaktion", "Inkrafttreten", "Bevölkerung", "Erkenntnisse",
            "Ausnahmen",
            "Ausschreibungen", "Streichung", "Ermächtigung", "Angaben", "Umfang", "Ziel", "Nachfolger", "Projektion",
            "Definition", "Land", "Bürgerliches", 'Fraktionen', 'Bundesamt', 'Zuständigkeit', 'Bundesamtes',
            'Zeitpunkt', 'Seite', 'Bestimmungen',
            'Streichung',
            'Ermächtigung', 'Leistungen', 'Angaben', 'Umfang', 'Ziel', 'Nachfolger', 'Neuregelung',
            'Bürgerliches', 'Erstellung',
            'Einschätzung', 'Aufgaben', 'Inwiefern', 'Warum',
            # noise 2021

            # parties
            'AFD', 'SPD', 'CDU', 'CSU', 'BÜNDNIS', 'GRÜNEN', 'LINKEN', 'FDP'
            # times
                                                                       'Januar', 'Februar', 'März', 'April', 'Mai',
            'Juni', "August", 'Juli', 'September', 'Oktober', 'November', 'Dezember',
